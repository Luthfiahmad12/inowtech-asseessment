...
<head>
    ...
    <title>Coding Test InowTech</title>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="flex items-center justify-center min-h-screen mt-4">
                    <div class="text-center">
                        <h1 class="mb-4 text-xl font-bold text-black">
                            Coding Test InowTech
                        </h1>
                        <img class="rounded-md shadow-xl" src="{{ asset('sources/bg.png') }}" alt="bg">
                    </div>
                </main>
